...
export const personalInfo: PersonalInfo = {
  ...
  about: 
  `数据建模与因果分析能力：精通多源数据融合、因果推断与不确定性分析，独立完成复杂系统建模与阈值识别，发表19篇论文，其中以第一作者发表4篇，具备从海量数据中提炼规律并驱动决策的工程化思维。\n
  复杂问题拆解与系统解决：长期研究多因子耦合系统（干旱传播、生态响应），擅长构建多变量联合诊断框架，将物理机制转化为可量化、可优化的技术方案，拥有两项授权发明专利，能快速切入业务痛点并提出系统性解法。\n
  项目推进与快速学习：独立主持1项校自主创新基金项目，并作为核心骨干参与3项国家级科研课题，具备独立跑通项目全流程的落地能力。获国家公派留学资格，能快速掌握新技术并转化为业务交付成果。\n
  团队管理与沟通协调：连续五年担任党团负责人，统筹组织协调与跨部门沟通，能在多任务并行中高效推进目标。`
};
